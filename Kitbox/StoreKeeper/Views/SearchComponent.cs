...
namespace Kitbox.StoreKeeper.Views
{
    ...
    public partial class SearchComponent : UserControl
    {
        ...
        public SearchComponent(MySqlConnection database, StoreKeeperWindow parent) 
        {
            InitializeComponent();
        ...
        public void GetComponents()
        {
            ...
            {
                reader = MethodsDB.DataBaseMethods.SqlSearch("Piece", "Ref", String.Format("'{0}'", pepTextbox1.Text), DataBase);
            }
            else
            {
                reader = MethodsDB.DataBaseMethods.SqlSearch("Piece", "Code", String.Format("'{0}'", pepTextbox1.Text.ToUpper()), DataBase);
            }
