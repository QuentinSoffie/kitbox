...
using Kitbox.StoreKeeper.Views;
...
namespace Kitbox.StoreKeeper
{
    ...
    /// </summary>
    public partial class StoreKeeperWindow : Form
    {
        ...
        public StoreKeeperWindow(MySqlConnection database, Authentication authentification, string username, string password)
        {
            InitializeComponent();
